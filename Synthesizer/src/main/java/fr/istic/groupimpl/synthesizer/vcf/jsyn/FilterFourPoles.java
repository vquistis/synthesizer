...
public class FilterFourPoles extends TunableFilter {
    ...
    public FilterFourPoles() {
        ...
        addPort(fm = new UnitInputPort("vcf_fm"));
    }
    ...
    public void recalculate() {
        double frequencyValue = converter(fm.get(), frequency.getValues()[0]);
     ...
     *   Frequency
     */
    public double converter(double fm, double f0) {
    	return f0*Math.pow(2, fm);
    }
